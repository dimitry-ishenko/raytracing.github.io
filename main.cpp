...
int main(int argc, char* argv[])
{
    ...
    world.add(new sphere3{ point3{ 0, -1000, 0}, 1000, mat_ground });
        ...
        for (int b = -11; b < 11; ++b)
        {
            ...
            if (len(center - point3{4, .2, 0}) > .9)
            {
                if (choice < .8) // diffuse
                {
                    ...
                    world.add(new sphere3{center, center1, .2, mat_sphere});
                }
                else if (choice < .95) // metal
                {
                    ...
                    world.add(new sphere3{ center, .2, mat_sphere });
                }
                else // glass
                {
    ...
    world.add(new sphere3{ point3{0, 1, 0}, 1, mat1 });

    auto mat2 = std::make_shared<lambert>(color3{.4, .2, .1});
    world.add(new sphere3{ point3{-4, 1, 0}, 1, mat2 });

    auto mat3 = std::make_shared<metal>(color3{.7, .6, .5}, 0);
    world.add(new sphere3{ point3{4, 1, 0}, 1, mat3 });
